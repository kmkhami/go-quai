...
func (w *worker) commitTransaction(env *environment, tx *types.Transaction) ([]*types.Log, error) {
	if tx != nil {
		...
		receipt, err := ApplyTransaction(w.chainConfig, w.core, &env.coinbase, env.gasPool, env.state, env.header, tx, &env.header.GasUsed[types.QuaiNetworkContext], *w.core.GetVMConfig())
		if err != nil {
